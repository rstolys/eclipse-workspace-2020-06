...
namespace Sender_SS
{
	...
	class CommonTransient_Sender_TopLevel : public virtual Sender_TopLevel_SenderSS
	{
			typedef Sender_TopLevel_SenderSS super;

		public:
			CommonTransient_Sender_TopLevel(){};
			CommonTransient_Sender_TopLevel(const string& name, BaseState* parent, SenderSS* mgr);
